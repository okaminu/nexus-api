...
class WorkTimeValidatorTest {
    ...
    fun `Validation fails when at least one work day start time follows after end time`() {
        ...
        assertFalse(WorkTimeValidator().isValid(workTime))
    }
